<div class='flex items-center justify-center min-h-screen from-teal-100 via-teal-300 to-teal-500 bg-gradient-to-br'>
    <div class='w-50 max-w-lg px-10 py-8 mx-auto bg-white rounded-lg shadow-xl'>
        <div class='max-w-md mx-auto space-y-6'>
            <form action="{{route('soldProduct.store')}}" style="max-width: 500px" method="POST" enctype="multipart/form-data" class="py-4 px-4">
                @csrf
                ...
                <input type="submit" class="py-3 px-6 my-2 bg-emerald-500 text-black font-medium rounded hover:bg-indigo-500 cursor-pointer ease-in-out duration-300 border-2" value="Send">
            </form>
        </div>
    </div>
</div>
