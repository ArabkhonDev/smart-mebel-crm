...
<div class="mt-4 rounded-xl border p-5 shadow-md w-9/12 bg-white">
    <div class="flex w-full items-center justify-between border-b pb-3">
        ...
        <div class="flex items-center space-x-8">
            <button class="rounded-2xl border bg-neutral-100 px-3 py-1 text-xs font-semibold">{{$soldProduct->id}}</button>
    ...
    <div class="mt-4 mb-6">
        <div class="flex">
            <div class="">
                <p class="mb-3 text-xl font-bold">{{$soldProduct->client_name}} {{$soldProduct->client_phone_number}}</p>
